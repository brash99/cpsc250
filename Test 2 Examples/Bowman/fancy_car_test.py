...
if __name__ == '__main__':
    ...
    my_car.start_engine()
    print(f"Engine started: {my_car.engine_on}")

    # does driving the car work?
    my_car.drive(50)
    print(f"odometer after driving 50 miles: {my_car.check_odometer()}")
    print(f"gas_tank after driving 50 miles: {my_car.check_gas_gauge()}")

    # does adding gas work?
    my_car.stop_engine()
    my_car.add_gas(5)
    print(f"gas_tank after adding 5 gallons: {my_car.check_gas_gauge()}")
